...
********************************************************************************
	...
	* identify variables thar are unique at the project level
	local single_values Project budget_USD spent_USD execution_rate date_start ///
	...
	active_* summary_implementor link pr_budget pr_budget_currency pr_total_spent pr_spending_currency
...
*2) Make table longer for effective visualization
	...
	drop `single_values' Outcome_* sum_* Programme_* Activity_*
